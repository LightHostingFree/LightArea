				...
				<div class="card-body">
					<div class="row align-items-center">
						...
						<div class="col">
							...
							<div class="text-muted">
								<a href="https://github.com/mahtab2003/LightArea/#help" class="text-muted" target="_blank">Check here.</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card-body">
					<div class="row align-items-center">
						...
						<div class="col">
							...
							<div class="text-muted">
								<a href="https://LightArea.eu.org/DONATE.md" class="text-muted" target="_blank">Donate here.</a>
							</div>
						</div>
					</div>
				</div>
